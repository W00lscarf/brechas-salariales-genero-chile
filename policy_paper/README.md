...
- **La asociación condicional vinculada a la maternidad es grande y estadísticamente significativa**: dentro de la misma ocupación exacta, las mujeres con hijos ganan un **7.8% adicional menos** (p < .001) respecto de lo que la brecha general ya les descuenta, mientras que para los hombres tener hijos se asocia a un *premio* salarial (+5.0%). La asociación se concentra en mujeres casadas o convivientes.
...
*Nota.* Descomposición ponderada por factores de expansión; Δ0 compara hombres y mujeres dentro del soporte común, reponderando la distribución masculina de celdas a la distribución femenina. Intervalo de confianza al 95% por bootstrap (500 réplicas) para Δ0 con ocupación a 4 dígitos: [15.3, 19.0]. La equivalencia se calcula como −Δ0/(1+Δ0). Elaboración propia a partir de CASEN 2022 y 2024.
...
- Parada-Contzen, M. y Jara, F. (2025). Gender wage gap among the educated: Evidence from fields of study in Chile. *Humanities and Social Sciences Communications*, *12*, 961. https://doi.org/10.1057/s41599-025-05312-x
