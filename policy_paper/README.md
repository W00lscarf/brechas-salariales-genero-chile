...
- Al aislar el efecto sexo ocupación por ocupación, **102 de 229 ocupaciones muestran brecha estadísticamente significativa — las 102 en contra de las mujeres; ninguna a favor**. Las brechas "pro-mujer" que aparecen en comparaciones simples no sobreviven el control de incertidumbre estadística.
...
- **Maternidad como stock, no como evento.** La pregunta `s5` de CASEN mide haber tenido hijos, no el evento del nacimiento; un estudio de eventos tipo Kleven et al. (2019) exige datos longitudinales que las encuestas de hogares chilenas no proveen.
